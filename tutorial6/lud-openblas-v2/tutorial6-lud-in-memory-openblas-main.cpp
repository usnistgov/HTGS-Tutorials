...
int main(int argc, char *argv[]) {
  ...
  for (int numTry = 0; numTry < numRetry; numTry++) {
    ...
    if (runSequential) {
      ...
      FactorUpperTask *factorUpperTask = new FactorUpperTask(numFactorUpperThreads, matrixSize, matrixSize, blockSize, gridHeight);
      ...
      MatrixMulPanelTask *matrixMulTask = new MatrixMulPanelTask(numMatrixMulThreads, matrixSize, matrixSize, matrixSize, matrixSize, blockSize);
