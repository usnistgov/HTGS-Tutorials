...
class MatrixMulBlkTask : public htgs::ITask<MatrixBlockMulData<MatrixMemoryData_t>, MatrixBlockData<MatrixMemoryData_t>> {
...
//    addResult(matCData);
// TODO: Fix
    // TODO: Release memory for upper matrix and lower after sync stream
  }
